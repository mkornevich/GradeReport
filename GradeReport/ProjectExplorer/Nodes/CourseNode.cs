...
namespace GradeReport.ProjectExplorer.Nodes
{
    public class CourseNode : PENode
    {
        public override string Description =>
            "Данный узел представляет один курс который принадлежит группе из узла выше.\n\n" +
            "В качестве вложенных элементов данного узла представлены семестры которые принадлежат данному курсу.";
